...
module.exports = {
    ...
    .addUserOption(
        option => option
        .setName("user")
        .setDescription("utilisateur à qui vous voulez envoyer une amende")
        .setRequired(true)
    )
    .addNumberOption(
        option => option
        .setName("montant")
        .setDescription("montant d'argent du au paiement de l'amende **(montant minimum de 1$)**")
        .setRequired(true)
        .setMinValue(1)
    )
    .addStringOption(
        option => option
        .setName("raison")
        .setDescription("raison de l'amende")
        .setRequired(true)
    ),
